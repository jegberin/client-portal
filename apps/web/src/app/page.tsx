  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center gap-8 p-8">
      ...
      <div className="flex gap-4">
        <Link
          href="/login"
          className="px-6 py-3 bg-[var(--primary)] text-white rounded font-medium hover:opacity-90 transition-opacity"
        >
          Sign In
        </Link>
        <Link
          href="/signup"
          className="px-6 py-3 border border-[var(--border)] rounded font-medium hover:bg-[var(--muted)] transition-colors"
        >
          Get Started
        </Link>
      </div>
